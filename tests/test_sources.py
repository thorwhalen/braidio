...
LINES = [
    ...
    TimedLine(
        2, 11.23, 15.83, "Spot in the Caribbean by providence, impoverished, in squalor"
    ),
...
def test_timed_line_segment_source_protocol():
    src = TimedLineSegmentSource(
        lines=LINES, asset_path="/tmp/song.mp3", song_end_s=236.77
    )
