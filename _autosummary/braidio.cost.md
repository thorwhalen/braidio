...
braidio’s only spend is ElevenLabs synthesis — [`braidio.narrate()`](braidio.md#braidio.narrate) /
...
[`braidio.Script`](braidio.md#braidio.Script) before any synthesis is paid for.
...
|----------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|
| [`estimate_cost`](#braidio.cost.estimate_cost)(source, \*[, model_id]) | Estimate ElevenLabs spend for a [`braidio.Script`](braidio.md#braidio.Script) or a raw string. |
...
Estimate ElevenLabs spend for a [`braidio.Script`](braidio.md#braidio.Script) or a raw string.
