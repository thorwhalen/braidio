...
The music bed ([`braidio.music`](braidio.music.md#module-braidio.music)) is the *continuous* music layer. This module
...
- a **sting** — a short musical marker — at a [`SceneBreak`](braidio.script.md#braidio.script.SceneBreak)
  (“new section”);
...
asset. It is the single seam [`braidio.render.render_production()`](braidio.render.md#braidio.render.render_production) takes
